...
# --- Sector info website ---------------------------------------------------
# Sent to a student once, when they press "Закончить квест" after the main
# route. Hosted for free on GitHub Pages from a separate repo
# (github.com/AsH3-git/akadem-quest-site) — see README for how to update
# the site content and re-deploy.
SITE_URL = "https://ash3-git.github.io/akadem-quest-site/"
